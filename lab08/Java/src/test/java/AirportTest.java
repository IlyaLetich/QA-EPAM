...
public class AirportTest {
    ...
    public void getTransportMilitaryPlanes() {
        ...
        transportMilitaryPlanes.forEach(militaryPlane -> Assert.assertSame(militaryPlane.getType(), MilitaryType.TRANSPORT));
    }
    ...
    @Test
    public void checkSortSortByMaxLoadCapacity() {
    ...
    public void getBomberMilitaryPlanes() {
        ...
        bomberMilitaryPlanes.forEach(militaryPlane -> Assert.assertSame(militaryPlane.getType(), MilitaryType.BOMBER));
    }

    @Test
    public void testExperimentalPlanesHasClassificationLevelHigherThanUnclassified(){
        List<ExperimentalPlane> experimentalPlanes = new Airport(planes).getExperimentalPlanes();
        experimentalPlanes.forEach(experimentalPlane ->
